...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/workspace/models/Qwen2.5-VL-7B-Instruct \
    actor_rollout_ref.model.encoder.path=/workspace/models/Qwen2.5-VL-7B-Instruct \
    actor_rollout_ref.model.llm.path=/workspace/models/Qwen2.5-VL-7B-Instruct \
    ...
    trainer.project_name='verl_grpo_example_geo3k_2' \
